            ...
            <div className='w-full flex h-screen lg:w-1/2 bg-gray-200 items-center justify-center'>
              <div className='bg-gray-50 px-14 mt-20 h-screen rounded-3xl bottom-0 border-2 border-gray-200'>
                {/* <h1 className='text-3xl font-semibold mt-12'>Kaduna Markets Tradefair</h1> */}
                    <p className='font-medium text-lg text-gray-500 mt-4'>Welcome to Kaduna Markets Tradefair vendor registration portal, unfortunately registration has closed. Thank you for your effort to participate at the Tradefair 3.0 </p>
                    <p className='font-medium text-lg text-gray-500 mt-4'>You can join us at our next Tradefair, see you soon!</p>
