...
import { FaHouseUser, FaMapMarkedAlt, FaStore } from 'react-icons/fa'
    ...
    <section className="text-gray-600 body-font">
        <div className="container px-5 py-2 mx-auto">
            ...
            <div className="p-4 sm:w-1/4 w-1/2">
                {/* <ShoppingCartIcon  '/> */}
                {/* <FaMapMarkedAlt/> */}
                <FaStore className='w-10 h-10 mx-auto my-5 text-gray-900 md:w-12 md:h-12 lg:w-18 lg:h-18'/>
                <h2 className="title-font font-medium text-xl md:text-2xl lg:text-3xl text-gray-900">+10,000</h2>
            ...
            <div className="p-4 sm:w-1/4 w-1/2">
                ...
                <h2 className="title-font font-medium text-xl md:text-2xl lg:text-3xl text-gray-900">5</h2>
