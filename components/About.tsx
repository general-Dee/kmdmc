                    ...
                    <div className="flex flex-col sm:flex-row mt-10">
                        <div className="sm:w-1/3 text-center sm:pr-8 sm:py-8">
                            ...
                            <div className="w-12 h-1 bg-indigo-500 rounded mt-2 mb-4"></div>
                                <p className="text-base">We are currently managing over thirty two (32) projects across the state, these projects cut across Commercial, Recreation and Hospitality.</p>
                            </div>
                        </div>
                        <div className="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-gray-200 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
                            <p className="leading-relaxed text-lg mb-4">We are currently managing over thirty two (32) projects across the state, eight (8) of which are state owned and twenty (24) are Public Private Partnership. These projects cut across Commercial, Recreation and Hospitality.
